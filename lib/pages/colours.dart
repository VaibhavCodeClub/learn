...
class _ColoursPageState extends State<ColoursPage> {
  final List<Colours> colours = [
    Colours(
      name: 'Blue',
      jpgAsset: 'assets/images/colors/blue.svg',
      bgColor: Colors.lightBlueAccent,
      fontColor: Colors.lightBlueAccent,
    ),
    Colours(
      name: 'Yellow',
      jpgAsset: 'assets/images/colors/yellow.svg',
      bgColor: Colors.yellow.shade600,
      fontColor: Colors.yellow.shade600,
    ),
    Colours(
      name: 'Black',
      jpgAsset: 'assets/images/colors/black.svg',
      bgColor: Colors.black,
      fontColor: Colors.black,
    ),
    Colours(
      name: 'Green',
      jpgAsset: 'assets/images/colors/green.svg',
      bgColor: Colors.green,
      fontColor: Colors.green,
    ),
    Colours(
      name: 'Pink',
      jpgAsset: 'assets/images/colors/pink.svg',
      bgColor: Colors.pink.shade300,
      fontColor: Colors.pink.shade300,
    ),
    Colours(
      name: 'White',
      jpgAsset: 'assets/images/colors/white.svg',
      bgColor: Colors.grey.shade400,
      fontColor: Colors.grey.shade400,
    ),
    Colours(
      name: 'Red',
      jpgAsset: 'assets/images/colors/red.svg',
      bgColor: Colors.red,
      fontColor: Colors.red,
    ),
    Colours(
      name: 'Violet',
      jpgAsset: 'assets/images/colors/violet.svg',
      bgColor: Colors.deepPurple,
      fontColor: Colors.deepPurple,
    ),
    Colours(
      name: 'Brown',
      jpgAsset: 'assets/images/colors/brown.svg',
      bgColor: Color(0xFF964B00),
      fontColor: Color(0xFF964B00),
    ),
    Colours(
      name: 'Orange',
      jpgAsset: 'assets/images/colors/orange.svg',
